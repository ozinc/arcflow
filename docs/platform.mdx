...
status: "stable"
playground:
  query: "MERGE (n:Host {id: 'platform-demo', name: 'ArcFlow', runtime: 'wasm', version: '2.0', portable: 1, modes: 3}) RETURN n.name, n.runtime, n.version, n.portable, n.modes"
---
...
- **CPU only** — full algorithm suite
- **CUDA GPU detected** — large workloads route to GPU automatically
...
A **fragment** is any lightweight ArcFlow instance that operates independently and syncs to [ArcFlow World](/world) when connected. Browsers, mobile devices, and PanoNodes are all fragments.
...
[Open ArcFlow Engine](/engine) in your browser. No installation. Persistent storage. Works offline. Syncs to ArcFlow Cloud when you're ready.
...
| **29 algorithms** | Full | Full | Full | Full | Full |
