---
title: "Agent Tooling"
description: "ArcFlow as ephemeral in-process world model for coding agents — spin up a spatial-temporal graph, run 27 algorithms, query results, and discard. No server, no setup."
section: "use-cases"
status: "stable"
playground:
  seed: world
