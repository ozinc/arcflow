...
description: "The grounding layer between neural world models and the operational world model — lift neural world model detections into persistent, queryable entities with spatial position, confidence, and temporal history."
section: "use-cases"
status: "stable"
playground:
  seed: world
