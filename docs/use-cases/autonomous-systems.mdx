...
description: "World Model infrastructure for autonomous systems — robot fleets, UAVs, self-driving vehicles, and industrial automation where shared spatial-temporal state is the operational foundation"
section: "use-cases"
status: "stable"
playground:
  seed: world
...
- [Grounded Neural Objects](/use-cases/grounded-neural-objects) — lifting detections into persistent entities
