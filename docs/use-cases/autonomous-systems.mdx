...
- [World Model](/concepts/world-model) — the two-layer framing: neural world models simulate, ArcFlow records
...
- [Spatial Queries](/spatial-knowledge) — ArcFlow Spatial Index, frustum, line-of-sight
...
- [Programs](/programs) — declare sensor fusion pipelines and perception programs as installable manifests with GPU hardware validation
- [Triggers](/worldcypher/triggers) — fire a skill automatically when a new sensor frame or detection node arrives
