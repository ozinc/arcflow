...
## Reactive monitoring — fire on state change
...
| Reactive alerts | Message broker + CDC | `db.subscribe()` in-process |
...
- [Reactive Queries](/reactive) — live subscriptions and materialized views
