...
description: "The operational world model layer for autonomous systems — persistence, spatial queries, and temporal memory that complete the stack beneath neural world models."
section: "use-cases"
status: "stable"
playground:
  seed: world
...
Neural world models are the prediction tier — generative engines that anticipate how the world evolves under actions. ArcFlow is the persistence tier — the operational world model that stores what actually happened, at what confidence, from which sensor, queryable at any sequence checkpoint.
...
- [Grounded Neural Objects](/use-cases/grounded-neural-objects) — lifting neural world models detections into persistent entities
