...
playground:
  query: |-
    ...
    MATCH (a1:Account {id: 'acc-001'}) MATCH (a2:Account {id: 'acc-002'}) MERGE (a1)-[:TRANSFERRED_TO {amount: 48000.0, seq: 1, flagged: 0}]->(a2)
    MATCH (a2:Account {id: 'acc-002'}) MATCH (a3:Account {id: 'acc-003'}) MERGE (a2)-[:TRANSFERRED_TO {amount: 47500.0, seq: 2, flagged: 1}]->(a3)
    MATCH (a3:Account {id: 'acc-003'}) MATCH (a4:Account {id: 'acc-004'}) MERGE (a3)-[:TRANSFERRED_TO {amount: 47200.0, seq: 3, flagged: 1}]->(a4)
