...
playground:
  query: |-
    MERGE (a1:Account {id: 'acc-001', name: 'Legit Corp', balance: 125000.0, kyc: 1, flagged: 0})

    MERGE (a2:Account {id: 'acc-002', name: 'Shell Alpha', balance: 840.0, kyc: 0, flagged: 1})

    MERGE (a3:Account {id: 'acc-003', name: 'Shell Beta', balance: 210.0, kyc: 0, flagged: 1})

    MERGE (a4:Account {id: 'acc-004', name: 'Offshore Sink', balance: 0.0, kyc: 0, flagged: 1})

    MATCH (a1:Account {id: 'acc-001'}), (a2:Account {id: 'acc-002'}) MERGE (a1)-[:TRANSFERRED_TO {amount: 48000.0, seq: 1, flagged: 0}]->(a2)

    MATCH (a2:Account {id: 'acc-002'}), (a3:Account {id: 'acc-003'}) MERGE (a2)-[:TRANSFERRED_TO {amount: 47500.0, seq: 2, flagged: 1}]->(a3)

    MATCH (a3:Account {id: 'acc-003'}), (a4:Account {id: 'acc-004'}) MERGE (a3)-[:TRANSFERRED_TO {amount: 47200.0, seq: 3, flagged: 1}]->(a4)
