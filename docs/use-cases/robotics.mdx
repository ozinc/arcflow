...
description: "ArcFlow as the operational world model layer for robotics — grounds neural world model outputs into persistent, spatially indexed, temporally versioned entity state."
section: "use-cases"
status: "stable"
playground:
  seed: world
