...
The other **57 / 60** ISO features are supported at conformance level full. The full feature inventory is verified continuously by the regression suite (see TCK + Regressions below).
