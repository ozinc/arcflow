---
title: "Glossary"
description: "Definitions for graph, GQL, and ArcFlow-specific terms"
section: "reference"
status: "stable"
---
...
**ArcFlow.** ArcFlow's implementation of ISO GQL, extended with temporal snapshots, reactive queries, confidence scoring, spatial predicates, constructors, and graph algorithm procedures. All standard GQL syntax works; WorldCypher adds what the standard leaves to implementations.
...
**ArcFlow.** A named, incrementally maintained query result. Created with `CREATE LIVE VIEW`, updated automatically as the underlying graph changes. Zero-cost reads — the result is pre-computed. Equivalent to a materialized view in SQL, but reactive.
