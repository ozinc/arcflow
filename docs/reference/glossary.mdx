...
**ArcFlow.** A persistent, spatial-temporal knowledge graph representing the state of a real or simulated environment. Entities have position, velocity, and observation class. Relationships carry provenance and confidence. The entire history is queryable via `AS OF seq N`. Used for robotics perception, game AI, digital twins, autonomous systems, and active inference agents.
