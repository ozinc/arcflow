...
An open specification of the Cypher query language that became a key input to the ISO GQL standard. ArcFlow passes ~56% of the openCypher TCK (2,192/3,881 scenarios, strict canonical; hardening in progress).
...
A test suite for verifying query language conformance. The openCypher TCK contains 3,881 scenarios; ArcFlow passes ~56% (2,192) at strict canonical equivalence, with hardening in progress under I-INIT-GQLC.
...
- [GQL Conformance](/reference/conformance/overview) — standards coverage
...
- [Programs](/programs) — `CREATE PROGRAM` capability manifests
