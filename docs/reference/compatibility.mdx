...
description: "Complete GQL compatibility matrix — supported syntax, ArcFlow extensions, and implementation status"
section: "reference"
status: "stable"
---
...
ArcFlow implements [ISO/IEC 39075 GQL](https://www.iso.org/standard/76120.html) as **WorldCypher** — its native query dialect. All standard GQL syntax works as specified. WorldCypher adds extensions for temporal snapshots, reactive queries, confidence scoring, and graph algorithms that GQL leaves to implementations.
