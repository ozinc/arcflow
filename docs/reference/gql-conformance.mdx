...
| Reactive queries | `LIVE MATCH (n:Label) RETURN n` | Standing query, re-evaluates on change |
...
| Graph algorithms | `CALL algo.pageRank()` | 30+ built-in — no projection lifecycle |
...
|---|---|---|---|
| **ArcFlow (WorldCypher)** | ✅ 100% (3881/3881) | ✅ Full | Plus temporal, reactive, and AI extensions |
