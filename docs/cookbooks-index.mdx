...
|---|---|---|---|---|
| [Agent Knowledge Base via Confidence-Scored GraphRAG](https://github.com/ozinc/arcflow/tree/main/cookbooks/agent-knowledge-base) | python, agent | ≤ 5 min | `1.6.6` | no |
| [Fraud Detection via Graph Traversal](https://github.com/ozinc/arcflow/tree/main/cookbooks/fraud-graph-traversal) | python, data-engineer | ≤ 5 min | `1.6.6` | no |
| [Multi-Stream Spatiotemporal World Model — 60 Hz Live Tracking + Synced Auxiliary Streams](https://github.com/ozinc/arcflow/tree/main/cookbooks/multi-stream-spatiotemporal-world-model) | python, data-engineer, ml, agent | ≤ 8 min | `1.6.6` | no |
| [Multi-Sensor Fusion with Trust-Weighted Live Alerts](https://github.com/ozinc/arcflow/tree/main/cookbooks/sensor-fusion-livequery) | python, ml | ≤ 5 min | `1.6.6` | no |
| [Temporal + Spatial Parquet Ingestion](https://github.com/ozinc/arcflow/tree/main/cookbooks/temporal-spatial-parquet-ingest) | python, data-engineer | ≤ 5 min | `1.6.6` | no |
