...
| Wave | Feature | Status |
|---|---|---|
| Wave A | WAL capture in mutation path | Done |
| Wave B | SyncEngine push/pull/cycle | Done (10 tests) |
| Wave C | TypeScript SDK integration | Done (syncPending, fingerprint) |
| Wave D | HTTP transport (reqwest) | Done |
| Wave E | Background auto-sync daemon | Done |
| Wave F | LAN peer discovery (UDP multicast) | Done |
| Wave G | WebSocket delta-push | Done |
| Wave H | WASM transport (browser fetch) | Planned |
