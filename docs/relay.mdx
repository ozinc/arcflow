...
status: "stable"
  query: "MERGE (ctrl:Agent {id: 'ctrl', name: 'ControlCenter', role: 'hub', hops: 0}) MERGE (fa:Agent {id: 'field-a', name: 'FieldAgent-Alpha', role: 'field', lat_ms: 12, hops: 1, zone: 'lab-a'}) MERGE (fb:Agent {id: 'field-b', name: 'FieldAgent-Beta', role: 'field', lat_ms: 14, hops: 1, zone: 'lab-b'}) MERGE (sa:Agent {id: 'sub-a', name: 'SubAgent-A1', role: 'subagent', lat_ms: 28, hops: 2, zone: 'lab-a'}) MERGE (ctrl:Agent {id: 'ctrl'})-[:RELAYS_TO {intent: 'patrol', priority: 1, channel: 'primary', reliability: 0.99}]->(fa:Agent {id: 'field-a'}) MERGE (ctrl:Agent {id: 'ctrl'})-[:RELAYS_TO {intent: 'inspect', priority: 2, channel: 'primary', reliability: 0.99}]->(fb:Agent {id: 'field-b'}) MERGE (fa:Agent {id: 'field-a'})-[:RELAYS_TO {intent: 'monitor', priority: 1, channel: 'local', reliability: 0.95}]->(sa:Agent {id: 'sub-a'}) MATCH (src:Agent)-[r:RELAYS_TO]->(dst:Agent) RETURN src.name AS from_agent, src.role, r.intent, r.priority, r.channel, r.reliability, dst.name AS to_agent, dst.role, dst.lat_ms AS latency_ms, dst.hops ORDER BY dst.hops, r.priority"
playground:
  query: "MERGE (ctrl:Agent {id: 'ctrl', name: 'ControlCenter', role: 'hub', hops: 0})\n\nMERGE (fa:Agent {id: 'field-a', name: 'FieldAgent-Alpha', role: 'field', lat_ms: 12, hops: 1, zone: 'lab-a', intent: 'patrol', priority: 1, channel: 'primary', reliability: 0.99})\n\nMERGE (fb:Agent {id: 'field-b', name: 'FieldAgent-Beta', role: 'field', lat_ms: 14, hops: 1, zone: 'lab-b', intent: 'inspect', priority: 2, channel: 'primary', reliability: 0.99})\n\nMERGE (sa:Agent {id: 'sub-a', name: 'SubAgent-A1', role: 'subagent', lat_ms: 28, hops: 2, zone: 'lab-a', intent: 'monitor', priority: 1, channel: 'local', reliability: 0.95})\n\nMERGE (c1:Agent {id: 'ctrl'})-[:RELAYS_TO]->(fa:Agent {id: 'field-a'})\n\nMERGE (c2:Agent {id: 'ctrl'})-[:RELAYS_TO]->(fb:Agent {id: 'field-b'})\n\nMERGE (fa1:Agent {id: 'field-a'})-[:RELAYS_TO]->(sa:Agent {id: 'sub-a'})\n\nMATCH (src:Agent)-[:RELAYS_TO]->(dst:Agent) RETURN src.name AS from_agent, src.role AS from_role, dst.name AS to_agent, dst.role AS to_role, dst.intent AS intent, dst.priority AS priority, dst.channel AS channel, dst.reliability AS reliability, dst.lat_ms AS latency_ms, dst.hops AS relay_hops ORDER BY dst.hops, dst.priority"
