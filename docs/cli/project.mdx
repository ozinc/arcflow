...
A FUSE bridge (AFP-0002) is also available for environments where macFUSE is
installed; it serves the same on-disk layout as a live mount. `arcflow project` is the
broadly portable form — no FUSE driver needed.
