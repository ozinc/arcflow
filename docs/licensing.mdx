...
| What | License |
|---|---|
| **SDK source** (this repo's `typescript/`, `python/`, `react/`, `mcp/`) | MIT |
...
Contact [hello@oz.com](mailto:hello@oz.com) to discuss source licensing terms.
...
The OISL applies only to the **engine binaries** that power the SDK. From a user perspective, this is transparent: install via [the install matrix](/docs/installation) and use the SDK; the licensing boundary is invisible at the call site.
...
- [Pricing](/pricing) — Community, Professional, and Enterprise tiers
- [Installation](/installation) — install ArcFlow; the license applies to the engine binaries
