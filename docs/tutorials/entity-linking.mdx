...
- [Use Case: Knowledge Management](/docs/use-cases/knowledge-management) — entity extraction in production pipelines
- [Skills](/docs/skills) — declarative rules that link entities automatically
