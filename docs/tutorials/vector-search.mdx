...
playground:
  query: |-
    ...
    MATCH (a:Document {id: 'doc-wm'}), (b:Document {id: 'doc-sp'}) MERGE (a)-[:RELATED_TO {strength: 0.92}]->(b)

    MATCH (a:Document {id: 'doc-wm'}), (b:Document {id: 'doc-conf'}) MERGE (a)-[:RELATED_TO {strength: 0.85}]->(b)

    MATCH (a:Document {id: 'doc-conf'}), (b:Document {id: 'doc-rag'}) MERGE (a)-[:RELATED_TO {strength: 0.88}]->(b)
