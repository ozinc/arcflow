...
playground:
  query: |-
    ...
    MERGE (a:Document {id: 'doc-wm'})-[:RELATED_TO {strength: 0.92}]->(b:Document {id: 'doc-sp'})

    MERGE (a:Document {id: 'doc-wm'})-[:RELATED_TO {strength: 0.85}]->(b:Document {id: 'doc-conf'})

    MERGE (a:Document {id: 'doc-conf'})-[:RELATED_TO {strength: 0.88}]->(b:Document {id: 'doc-rag'})
