...
playground:
  query: |-
    ...
    MERGE (wm:Document {id: 'doc-world-model'})-[:RELATED_TO {strength: 0.94, method: 'semantic'}]->(sq:Document {id: 'doc-spatial'})

    MERGE (wm:Document {id: 'doc-world-model'})-[:RELATED_TO {strength: 0.89, method: 'semantic'}]->(cs:Document {id: 'doc-confidence'})

    MERGE (cs:Document {id: 'doc-confidence'})-[:RELATED_TO {strength: 0.92, method: 'semantic'}]->(rg:Document {id: 'doc-rag'})
