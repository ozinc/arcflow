...
playground:
  query: |-
    ...
    MATCH (wm:Document {id: 'doc-world-model'}), (sq:Document {id: 'doc-spatial'}) MERGE (wm)-[:RELATED_TO {strength: 0.94, method: 'semantic'}]->(sq)

    MATCH (wm:Document {id: 'doc-world-model'}), (cs:Document {id: 'doc-confidence'}) MERGE (wm)-[:RELATED_TO {strength: 0.89, method: 'semantic'}]->(cs)

    MATCH (cs:Document {id: 'doc-confidence'}), (rg:Document {id: 'doc-rag'}) MERGE (cs)-[:RELATED_TO {strength: 0.92, method: 'semantic'}]->(rg)
