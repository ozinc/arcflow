...
- **Autonomous robots** — task planning, obstacle avoidance, sensor-reactive recovery sequences grounded in live world model state
- **UAV fleets** — formation maintenance, mission assignment, reactive waypoint navigation
...
- [Reactive Queries](/reactive) — standing queries that trigger tree re-evaluation
