...
playground:
  seed: world
  query: "MERGE (leader:Agent {id: 'swarm-lead', name: 'Alpha-Lead', role: 'leader', active: 1, x: 0.0, y: 0.0})\n\nMERGE (f1:Agent {id: 'swarm-f1', name: 'Follower-01', role: 'follower', active: 1, x: 18.0, y: 8.5, intent: 'patrol', priority: 1, min_trust: 0.88})\n\nMERGE (f2:Agent {id: 'swarm-f2', name: 'Follower-02', role: 'follower', active: 1, x: -17.0, y: -9.0, intent: 'inspect', priority: 2, min_trust: 0.85})\n\nMERGE (f3:Agent {id: 'swarm-f3', name: 'Follower-03', role: 'follower', active: 1, x: 2.0, y: 1.5, intent: 'hold', priority: 3, min_trust: 0.80})\n\nMERGE (s1:Sensor {id: 'cam-1', name: 'Cam-LabA', type: 'camera', reliability: 0.95})\n\nMERGE (s2:Sensor {id: 'lidar-1', name: 'Lidar-LabB', type: 'lidar', reliability: 0.91})\n\nMERGE (la:Agent {id: 'swarm-lead'})-[:COORDINATES]->(fa:Agent {id: 'swarm-f1'})\n\nMERGE (lb:Agent {id: 'swarm-lead'})-[:COORDINATES]->(fb:Agent {id: 'swarm-f2'})\n\nMERGE (lc:Agent {id: 'swarm-lead'})-[:COORDINATES]->(fc:Agent {id: 'swarm-f3'})\n\nMERGE (f1a:Agent {id: 'swarm-f1'})-[:MONITORS]->(s1a:Sensor {id: 'cam-1'})\n\nMERGE (f2a:Agent {id: 'swarm-f2'})-[:MONITORS]->(s2a:Sensor {id: 'lidar-1'})\n\nMATCH (leader:Agent)-[:COORDINATES]->(follower:Agent) RETURN leader.name AS swarm_leader, follower.name AS agent, follower.x AS agent_x, follower.y AS agent_y, follower.intent AS assigned_intent, follower.priority AS order, follower.min_trust AS min_trust ORDER BY follower.priority"
