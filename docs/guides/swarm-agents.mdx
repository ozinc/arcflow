...
playground:
  seed: world
  query: |-
    MERGE (leader:Agent {id: 'swarm-lead', name: 'Alpha-Lead', role: 'leader', active: true, x: 0.0, y: 0.0})
    MERGE (f1:Agent {id: 'swarm-f1', name: 'Follower-01', role: 'follower', active: true, x: 18.0, y: 8.5})
    MERGE (f2:Agent {id: 'swarm-f2', name: 'Follower-02', role: 'follower', active: true, x: -17.0, y: -9.0})
    MERGE (f3:Agent {id: 'swarm-f3', name: 'Follower-03', role: 'follower', active: true, x: 2.0, y: 1.5})
