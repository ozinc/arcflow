...
| **Query language** | Varies by graph stack | WorldCypher (ArcFlow's GQL dialect with spatial/temporal/live extensions) |
...
- [Built-in Functions](/worldcypher/functions/built-in) -- all 93 functions
