...
since: "8.0.0"
status: "stable"
  query: "MERGE (m1:Module {id: 'mod-auth', name: 'auth', filepath: 'src/auth.ts', loc: 320, coverage: 0.91}) MERGE (m2:Module {id: 'mod-db', name: 'database', filepath: 'src/db/client.ts', loc: 180, coverage: 0.73}) MERGE (f1:Function {id: 'fn-login', name: 'login', module: 'auth', line: 42, complexity: 4, tested: 1}) MERGE (f2:Function {id: 'fn-validate', name: 'validateToken', module: 'auth', line: 28, complexity: 2, tested: 1}) MERGE (f3:Function {id: 'fn-query', name: 'executeQuery', module: 'database', line: 15, complexity: 3, tested: 0}) MERGE (m1:Module {id: 'mod-auth'})-[:CONTAINS {exported: 1}]->(f1:Function {id: 'fn-login'}) MERGE (m1:Module {id: 'mod-auth'})-[:CONTAINS {exported: 0}]->(f2:Function {id: 'fn-validate'}) MERGE (m2:Module {id: 'mod-db'})-[:CONTAINS {exported: 1}]->(f3:Function {id: 'fn-query'}) MERGE (f1:Function {id: 'fn-login'})-[:CALLS {hot_path: 1, call_site: 42}]->(f2:Function {id: 'fn-validate'}) MERGE (f2:Function {id: 'fn-validate'})-[:CALLS {hot_path: 0, call_site: 31}]->(f3:Function {id: 'fn-query'}) MATCH (m:Module)-[:CONTAINS]->(caller:Function)-[c:CALLS]->(dep:Function) RETURN m.name AS module, m.coverage AS test_coverage, caller.name AS function, caller.complexity, c.hot_path, dep.name AS calls, dep.tested ORDER BY caller.complexity DESC"
playground:
  query: "MERGE (m1:Module {id: 'mod-auth', name: 'auth', filepath: 'src/auth.ts', loc: 320, coverage: 0.91})\n\nMERGE (m2:Module {id: 'mod-db', name: 'database', filepath: 'src/db/client.ts', loc: 180, coverage: 0.73})\n\nMERGE (f1:Function {id: 'fn-login', name: 'login', module: 'auth', line: 42, complexity: 4, tested: 1, exported: 1, hot_path: 1})\n\nMERGE (f2:Function {id: 'fn-validate', name: 'validateToken', module: 'auth', line: 28, complexity: 2, tested: 1, exported: 0, hot_path: 1})\n\nMERGE (f3:Function {id: 'fn-query', name: 'executeQuery', module: 'database', line: 15, complexity: 3, tested: 0, exported: 1, hot_path: 0})\n\nMERGE (m1:Module {id: 'mod-auth'})-[:CONTAINS]->(f1:Function {id: 'fn-login'})\n\nMERGE (m1a:Module {id: 'mod-auth'})-[:CONTAINS]->(f2:Function {id: 'fn-validate'})\n\nMERGE (m2a:Module {id: 'mod-db'})-[:CONTAINS]->(f3:Function {id: 'fn-query'})\n\nMERGE (f1a:Function {id: 'fn-login'})-[:CALLS]->(f2a:Function {id: 'fn-validate'})\n\nMERGE (f2b:Function {id: 'fn-validate'})-[:CALLS]->(f3a:Function {id: 'fn-query'})\n\nMATCH (m:Module)-[:CONTAINS]->(caller:Function)-[:CALLS]->(dep:Function) RETURN m.name AS module, m.coverage AS test_coverage, caller.name AS function, caller.complexity AS complexity, caller.exported AS exported, caller.hot_path AS hot_path, dep.name AS calls, dep.tested AS dep_tested ORDER BY caller.complexity DESC"
