...
description: "Build a persistent world model of your codebase — every symbol, call, import, and commit as a queryable graph node with impact analysis, live views, and no LLM calls for navigation."
order: 9
status: "stable"
playground:
