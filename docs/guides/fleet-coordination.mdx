...
- [Physical AI Deployment](/markets/physical-ai) — the two-tier architecture this fleet layer sits in
...
- [Live Queries](/live-queries) — standing queries for live fleet monitoring
