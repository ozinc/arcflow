...
playground:
  query: |-
    ...
    MATCH (s:Sensor {id: 'primary-cam'}), (a1:Robot {id: 'bot-a'}) MERGE (s)-[:DETECTED {confidence: 0.94, method: 'vision'}]->(a1)
    MATCH (s:Sensor {id: 'primary-cam'}), (a2:Robot {id: 'bot-b'}) MERGE (s)-[:DETECTED {confidence: 0.91, method: 'vision'}]->(a2)
