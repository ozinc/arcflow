...
- [Agent Governance](/cli/governance) — verification state machine, receipts, and enforcement hooks
- [Plugin Management](/cli/plugin) — extend the runtime with `arcflow plugin install`
