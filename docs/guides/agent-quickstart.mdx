...
description: "Embed a World Model database in any project in 60 seconds — spatial-temporal, confidence-scored, in-process. For Claude Code, Codex, Cursor, Copilot."
section: "guides"
status: "stable"
---
