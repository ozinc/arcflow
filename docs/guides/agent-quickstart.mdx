...
playground:
  query: |-
    ...
    MERGE (s:Sensor {id: 'primary-cam'})-[:DETECTED {confidence: 0.94, method: 'vision'}]->(a1:Robot {id: 'bot-a'})

    MERGE (s:Sensor {id: 'primary-cam'})-[:DETECTED {confidence: 0.91, method: 'vision'}]->(a2:Robot {id: 'bot-b'})
