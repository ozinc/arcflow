...
// Create a relationship (MATCH existing nodes first, then MERGE the edge)
...
try {
  // Create
  db.batchMutate([
    "MERGE (alice:Person {id: 'p1', name: 'Alice', age: 30})",
    "MERGE (bob:Person {id: 'p2', name: 'Bob', age: 35})",
    "MERGE (acme:Org {id: 'o1', name: 'Acme', industry: 'tech'})",
  ])
  db.mutate("MATCH (a:Person {id: 'p1'}) MATCH (o:Org {id: 'o1'}) MERGE (a)-[:WORKS_AT]->(o)")
