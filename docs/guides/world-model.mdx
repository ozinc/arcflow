...
```cypher
-- K-nearest: 5 entities closest to a point (ArcFlow Spatial Index backed)
...
- Your application needs to answer questions about entities in space — where they are, how close they are to each other, what is visible from a given point — faster than a relational database with spatial extensions can provide.
