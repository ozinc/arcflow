...
- Reactive monitoring — the model tells you when anything changes
...
## 7. Reactive monitoring — the world tells you

Polling is not a world model. It is a sampling strategy — and it introduces latency proportional to the polling interval.

ArcFlow's reactive layer inverts this: you declare what you care about, and the model notifies you the moment it changes.
...
| Reactive standing queries | Zero-latency notification — no polling, no scheduler |
...
- [Reactive Queries](/reactive) — standing queries and live views in depth
