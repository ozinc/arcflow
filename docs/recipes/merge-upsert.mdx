...
playground:
  query: |-
    ...
    ON CREATE SET r.battery = 100, r.task = 'standby', r.created = 1, r.version = 1, r.speed = 0.5
    ON MATCH SET r.battery = 88, r.task = 'active', r.updated = 1, r.version = 2, r.speed = 1.1
