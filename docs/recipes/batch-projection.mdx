...
status: "stable"
playground:
  query: "MERGE (w1:Workstation {id: 'ws-01', name: 'Station-Alpha', type: 'assembly', x: 20.0, y: 15.0, capacity: 3, active: 1}) MERGE (w2:Workstation {id: 'ws-02', name: 'Station-Beta', type: 'inspection', x: -20.0, y: 15.0, capacity: 2, active: 1}) MERGE (w3:Workstation {id: 'ws-03', name: 'Station-Gamma', type: 'charging', x: 0.0, y: -20.0, capacity: 4, active: 1}) MATCH (w:Workstation) RETURN w.name AS station, w.type AS type, w.capacity AS capacity, w.x AS pos_x, w.y AS pos_y ORDER BY capacity DESC"
