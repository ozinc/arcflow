...
**Behavior trees that persist across restarts, remember their history, and query their own state with GQL.**
...
| Reactive Sequence | Live queries + subscriptions | GQL-based reactivity |
