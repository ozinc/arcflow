...
*Canonical surface for the [Behavior Engine](/docs/concepts/layers/behavior-engine) layer.*
...
| Live-Trigger Sequence | Live queries + subscriptions | GQL-based live queries |
...
- **GPU acceleration** — graph algorithms and vector search route to CUDA / Metal automatically
...
- [Use Case: Behavior Graphs](/docs/use-cases/behavior-graphs) — lightweight implementation sketch and architecture overview
- [Use Case: Autonomous Systems](/docs/use-cases/autonomous-systems) — multi-agent fleet coordination with behavior trees
