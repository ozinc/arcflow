...
- [Use Case: Behavior Graphs](/markets/behavior-graphs) — lightweight implementation sketch and architecture overview
- [Use Case: Autonomous Systems](/markets/autonomous-systems) — multi-agent fleet coordination with behavior trees
