...
description: "ArcFlow Edge Mesh — a distributed graph database that runs everywhere, not just one data center"
...
|---|---|---|
| **Query language** | Cypher | WorldCypher (GQL — ISO/IEC 39075 + spatial/temporal/reactive extensions) |
| **Graph algorithms** | Separate analytics product (paid) | 20+ built-in, free |
