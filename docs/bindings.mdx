...
description: "One world model engine, every language — native bindings for Rust, Python, TypeScript (napi-rs), C, C++, and Docker with zero serialization overhead."
section: "bindings"
order: 1
since: "10.0.0"
status: "stable"
...
- [Platform](/platform) — runtime environments: browser WASM, Docker, Cloudflare Workers, mobile
