...
```bash
curl -fsSL https://arcflow.dev/install | sh  # Native binary
...
ctypes bindings over the native C ABI. No PyO3 compile step needed — loads the shared library at runtime.
