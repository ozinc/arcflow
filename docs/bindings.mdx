...
For zero-install demos, the WASM playground at
[staging.oz.com/engine](https://staging.oz.com/engine) runs the same
engine in your browser.

The decision is recorded as `status: refused` in the engine release manifest
([RELEASE-MATRIX.toml](https://github.com/ozinc/arcflow/blob/main/RELEASE-MATRIX.toml)).
