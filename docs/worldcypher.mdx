...
playground:
  ...
  query: |-
    ...
    WITH s, d, r, z, s.reliability * d.confidence AS perception_quality, r.battery * d.confidence AS operational_score
    RETURN s.name AS sensor, s.type AS modality, perception_quality, d.method, r.name AS robot, r.task, r.battery, operational_score, z.name AS zone, z.hazard ORDER BY operational_score DESC
