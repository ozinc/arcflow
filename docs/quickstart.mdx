---
title: "World Model in 5 Minutes"
description: "Build your first spatial-temporal world model in 5 minutes — entities, relationships, confidence scores, graph algorithms, all in-process"
section: "get-started"
status: "stable"
---

# World Model in 5 Minutes

ArcFlow is the World Model database — spatial-temporal, confidence-scored, embedded. No server. No setup. Two lines to a running world model.
