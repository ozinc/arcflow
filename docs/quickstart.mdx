...
### Spatial proximity query (ArcFlow Spatial Index, ≥ 2,000/s at 11K entities)
...
- [Autonomous Systems](/docs/use-cases/autonomous-systems) — robot fleets and UAV coordination
- [Digital Twins](/docs/use-cases/digital-twins) — live replica of physical systems
