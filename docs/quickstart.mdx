...
ArcFlow is the World Model database — spatial-temporal, confidence-scored, embedded. No server. No round-trip. One call to open a database, one query language for spatial proximity, temporal replay, graph traversal, and real-time algorithms.
