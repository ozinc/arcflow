...
kind: capability
description: "37 graph algorithms operating over a confidence-scored, temporally-versioned world model — from entity resolution to contradiction detection to causal lineage walks to substrate-level multi-source disagreement resolution to trajectory analytics, 6 running incrementally as standing queries"
status: "stable"
playground:
  seed: world
