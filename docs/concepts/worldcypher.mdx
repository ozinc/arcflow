...
description: "How to query the operational world model — ISO/IEC 39075 GQL (WorldCypher) with Cypher compatibility, plus temporal, spatial, and live query extensions."
section: "concepts"
status: "stable"
playground:
  seed: world
