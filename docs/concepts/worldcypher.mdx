...
ArcFlow's implementation of GQL is called **WorldCypher**. It passes 100% of the openCypher TCK (3881/3881 scenarios), fully implements ISO GQL V2, and adds extensions for temporal, reactive, and AI workloads.
