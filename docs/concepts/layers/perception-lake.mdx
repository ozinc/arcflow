---
title: "1. Perception Lake"
kind: concept
description: "The immutable-observation layer. Raw frames, telemetry samples, sensor streams, and pre-graph row data — append-only, columnar, partitioned by time × source."
status: "stable"
---
