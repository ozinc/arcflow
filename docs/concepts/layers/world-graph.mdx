...
title: "2. World Graph"
kind: concept
description: "The topology + mutable-state layer. Owns identity, edges, low-cardinality node tables, and the catalog that binds graph queries to underlying storage."
status: "stable"
---
