...
The complete surface is enumerated in the [Procedures](/docs/worldcypher/functions/procedures) reference; this page documents the *layer* — why it exists, where it sits, and what guarantees it offers.
...
- It does not own storage. Storage lives in [Perception Lake](/docs/concepts/layers/perception-lake) + [World Graph](/docs/concepts/layers/world-graph).
