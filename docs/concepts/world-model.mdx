...
- [Grounded Neural Objects](/markets/grounded-neural-objects) — lifting neural world model outputs into persistent ArcFlow entities
- [Autonomous Systems](/markets/autonomous-systems) — the two-layer stack applied to robot fleets and UAV coordination
