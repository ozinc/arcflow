...
Response includes: 27 graph algorithms (pageRank, louvain, dijkstra, graphRAG, etc.), full CALL procedure suite, 83 built-in functions, observation classes (observed, inferred, predicted), and all supported query clauses.
