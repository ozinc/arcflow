...
playground:
  query: |-
    MERGE (r:Robot {id: 'r1', name: 'Atlas-01', task: 'assembly', x: 18.0, y: 8.5, speed: 1.2, battery: 87})

    SET r.battery = 94, r.status = 'charging', r.dock_seq = 310, r.updated = true
    
    MATCH (r:Robot {id: 'r1'}) RETURN r.name, r.task, r.battery, r.status, r.dock_seq, r.updated, r.x, r.y
