...
description: "27 graph algorithms built into the world model engine — centrality, community detection, similarity, shortest path, vector search, and GraphRAG. No projection catalog, no setup."
section: "worldcypher"
status: "stable"
playground:
  seed: world
