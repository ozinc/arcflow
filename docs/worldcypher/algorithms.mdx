...
description: "29 graph algorithms built into the world model engine — centrality, community detection, similarity, shortest path, vector search, and GraphRAG. No projection catalog, no setup."
status: "stable"
playground:
  seed: world
...
ArcFlow includes 29 graph algorithms that run directly — no projection catalog, no setup, no teardown.
