...
> **Sequence is the temporal axis.** Use `AS OF seq N` — exact and replayable. Wall-clock timestamps are not a temporal axis: `AS OF <timestamp>` is rejected (`DEPRECATED_AS_OF_TIMESTAMP`).

This page is the query-syntax reference; see [Temporal Queries](/temporal) for the canonical treatment of clock domains, domain-tick queries, and deterministic replay.
...
- [Use Case: Autonomous Systems](/docs/use-cases/autonomous-systems) — temporal reasoning in autonomous agents
