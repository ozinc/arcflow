...
playground:
  ...
  query: |-
    ...
    RETURN r.name AS entity, r.task, r.x AS pos_x, r.y AS pos_y, velocity, energy, occ.entered_seq AS entry_seq, observation_quality, d.method AS detection_method, z.name AS current_zone ORDER BY velocity DESC
