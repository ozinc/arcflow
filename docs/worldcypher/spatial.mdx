...
description: "Query world model positions exactly — KNN, radius, frustum, and live geofencing backed by the ArcFlow Spatial Index, no approximate indexing"
status: "stable"
playground:
  seed: world
